...
# TO DO write function to get input from map.py to get network
...
def create_visitor_agent(nid, agent_type, rank, **kwargs):
    return VisitorAgent(nid, agent_type, rank)


def restore_agent(agent_data):
    uid = agent_data[0]
    return VisitorAgent(uid[0], uid[1], uid[2], agent_data[1])
...
class Model:
    ...
    def __init__(self, comm, params):
        ...
        read_network(fpath, self.context, create_visitor_agent, restore_agent)
